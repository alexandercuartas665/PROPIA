...
/// <summary>
/// Servidor de correo saliente de la plataforma (Super Admin). GLOBAL y singleton (una sola fila).
/// Sirve para enviar correos transaccionales (invitaciones de usuarios 2.5, OTP de onboarding 2.1,
/// notificaciones T.2). Compatible con cualquier SMTP (SendGrid, Gmail, Mailgun, etc.). La clave se
/// guarda cifrada (ISecretProtector) y nunca se expone ni se loggea. Portado de CUBOT.travels.
/// </summary>
public class EmailConfig : BaseEntity
{
    ...
    /// <summary>Ultima validacion exitosa de la conexion SMTP.</summary>
