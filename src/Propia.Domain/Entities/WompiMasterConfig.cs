...
/// <summary>
/// Configuracion maestra de Wompi del dueno de la plataforma (Super Admin). GLOBAL y singleton:
/// con ella PROPIA cobra las suscripciones del modulo 0.2 a sus clientes. La llave privada y los
/// secrets se guardan cifrados (ISecretProtector) y nunca se exponen completos ni se loggean.
/// Portado de CUBOT.travels. Complementa el billing existente (MetodoPago/Factura/IntentoCobro):
/// aqui viven las llaves maestras de la plataforma (antes solo en appsettings) y el webhook.
/// </summary>
